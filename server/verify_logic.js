import { VersionedTransaction, LAMPORTS_PER_SOL, Keypair, TransactionMessage, PublicKey } from '@solana/web3.js';
import { createJitoTipInstruction } from './lib/jito.js';
...
async function verifyLogic() {
  ...
  try {
    ...
    const serialized = Buffer.from(tipTransaction.serialize());
