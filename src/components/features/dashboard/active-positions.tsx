  ...
  return (
    <div className="flex flex-col gap-3 h-full overflow-hidden">
      <div className="flex justify-between items-center px-1">
        ...
        <span className="font-mono text-[10px] text-gray-500">{paperPositions.length} TOKENS</span>
      </div>

      <div className="flex-1 space-y-2 overflow-y-auto custom-scrollbar">
        {paperPositions.length === 0 ? (
          <div className="flex flex-col justify-center items-center opacity-30 h-full text-gray-500">
            <p className="text-[10px] uppercase tracking-tighter">No active bags</p>
          </div>
        ) : (
